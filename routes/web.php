    ...
    // ______________________ REDI DGP ______________________
     ...
     Route::prefix('redi-dgp')->middleware('UsuarioDgp')->group(function () {
        ...
        Route::prefix('herramientas')->group(function () {
            ...
            Route::get('/procedimientos', [ProcedimientosController::class, 'index'])->name('herramientas.procedimientos');
            Route::get('/procedimientos/{procedimiento}', [ProcedimientosController::class, 'verProcedimiento'])->name('procedimientos.ver');
        });
