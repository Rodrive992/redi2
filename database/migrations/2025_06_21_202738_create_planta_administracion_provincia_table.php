...
class CreatePlantaAdministracionProvinciaTable extends Migration
{
    public function up()
    {
        Schema::create('planta_administracion_provincia', function (Blueprint $table) {
            $table->id('id_cargo');
            $table->string('legajo');
            $table->string('nombre');
            $table->string('dni');
    ...
    {
        Schema::dropIfExists('planta_administracion_provincia');
    }
}